...
import com.roowoo.log.common.utils.PropertiesLoader;
...
private static Logger logger = LoggerFactory.getLogger(Global.class);
	...
	public static final String jdbc_type = "mysql";

	public static final String productName = "日志分析";

	public static final String admin_path = "/a";

	public static final String frontPath = "/f";

	public static final String urlSuffix = ".html";

	public static final String demoMode = "false";
